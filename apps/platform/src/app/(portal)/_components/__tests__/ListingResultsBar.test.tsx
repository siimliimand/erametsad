...
describe('ListingResultsBar view toggle', () => {
  it('renders the demo aria-pressed state for the default list view', () => {
    ...
    expect(html).toContain('class="hidden sm:inline">Kaardivaade</span>')
    expect(html).toContain('class="hidden sm:inline">Loendivaade</span>')
    expect(button({ 'aria-label': 'Kaardivaade' })).toBeDefined()
    expect(button({ 'aria-label': 'Loendivaade' })).toBeDefined()
