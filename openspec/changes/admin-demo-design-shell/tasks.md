...
- [ ] 2.1 Restyle the rail to the demo: white surface bg, right border, mist logo chip with primary icon; drop the primaryDark/white-10 treatment <!-- agent: fullstack-engineer.build, depends_on: [1.2], touches: [apps/platform/src/app/(admin)/_components/AdminShell.tsx] -->
- [ ] 2.2 Restyle AdminNav states: muted icons, tint hover, strong-tint active + 3px primary left indicator, dark tooltip badge; restyle the horizontal mobile pills with demo tints <!-- agent: fullstack-engineer.build, depends_on: [1.2], touches: [apps/platform/src/app/(admin)/_components/AdminNav.tsx] -->
...
- [ ] 3.1 Restyle DataTable to demo density: mist header row at label size, 13px/18px body cells, hover row highlight, edge-cell padding <!-- agent: fullstack-engineer.build, depends_on: [1.2], touches: [apps/platform/src/app/(admin)/_components/DataTable.tsx] -->
- [ ] 3.2 Restyle PageHeader: breadcrumb line, 28px/34px font-heading 700 title, right-aligned action slot <!-- agent: fullstack-engineer.build, depends_on: [1.2], touches: [apps/platform/src/app/(admin)/_components/PageHeader.tsx] -->
- [ ] 3.3 Restyle FormField and ErrorNotice to the admin token scale (label 12px, input radius/border, danger banner styling) <!-- agent: fullstack-engineer.build, depends_on: [1.2], touches: [apps/platform/src/app/(admin)/_components/FormField.tsx, apps/platform/src/app/(admin)/_components/ErrorNotice.tsx] -->
